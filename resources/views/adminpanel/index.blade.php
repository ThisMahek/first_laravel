                ...
                <div class="card-statistic-3">
                  ...
                  <div class="card-content">
                    ...
                    <p class="mb-0 text-sm">
                      <span class="mr-2"><i class="fa fa-arrow-up"></i> 40%</span>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped" id="book-list">
                      ...
                      <tr>
                        <td>
                          <div class="media">
                            <img alt="image" class="mr-3 rounded-circle" width="40" src="{{url('admin/img/users/user-1.png')}}">
                      ...
                      <tr>
                        <td>
                          <div class="media">
                            <img alt="image" class="mr-3 rounded-circle" width="40" src="{{url('admin/img/users/user-2.png')}}">
                            <div class="media-body">
                      ...
                      <tr>
                        <td>
                          <div class="media">
                            <img alt="image" class="mr-3 rounded-circle" width="40" src="{{url('admin/img/users/user-3.png')}}">
                            <div class="media-body">
                      ...
                      <tr>
                        <td>
                          <div class="media">
                            <img alt="image" class="mr-3 rounded-circle" width="40" src="{{url('admin/img/users/user-4.png')}}">
                            <div class="media-body">
                      ...
                      <tr>
                        <td>
                          <div class="media">
                            <img alt="image" class="mr-3 rounded-circle" width="40" src="{{url('admin/img/users/user-5.png')}}">
                            <div class="media-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <td class="text-truncate">
                          <ul class="list-unstyled order-list m-b-0 m-b-0">
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{url('admin/img/users/user-8.png')}}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Wildan Ahdian"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{url('admin/img/users/user-9.png')}}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="John Deo"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{url('admin/img/users/user-10.png')}}" alt="user" data-toggle="tooltip" title=""
                      ...
                      <tr>
                        ...
                        <td class="text-truncate">
                          <ul class="list-unstyled order-list m-b-0 m-b-0">
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{url('admin/img/users/user-3.png')}}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Wildan Ahdian"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{url('admin/img/users/user-7.png')}}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Sarah Smith"></li>
                      ...
                      <tr>
                        ...
                        <td class="text-truncate">
                          <ul class="list-unstyled order-list m-b-0 m-b-0">
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{url('admin/img/users/user-1.png')}}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Wildan Ahdian"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{url('admin/img/users/user-5.png')}}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="John Deo"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{url('admin/img/users/user-9.png')}}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Sarah Smith"></li>
                      ...
                      <tr>
                        ...
                        <td class="text-truncate">
                          <ul class="list-unstyled order-list m-b-0">
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{url('admin/img/users/user-4.png')}}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Wildan Ahdian"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{url('admin/img/users/user-7.png')}}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="John Deo"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                ...
                                data-original-title="John Deo"></li>
                            <li class="team-member team-member-sm"><img class="rounded-circle"
                                src="{{url('admin/img/users/user-2.png')}}" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Sarah Smith"></li>
